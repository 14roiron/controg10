...
<html lang="fr">
  <head>
    ...
    <meta charset="utf-8" />
    <title>Controverse Groupe N°10</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <link rel="icon" type="image/ico" href="img/mines.ico" />
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="banner">
      <div class="container">
        ...
        <button class="navbar-toggle" type="button" data-toggle="collapse" data-target=".navbar-collapse">
          <span class="sr-only" id="headerTitrebis">Les mesures des productions scientifiques</span>
        </button> 
        <a href="index.php" class="navbar-left navbar-brand">Les mesures des productions scientifiques</a></div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="well well-lg">
              <div class="row">
                <div class="col-sm-4">
                  <img src="img/mines.png" class="img-responsive" />
                </div>
                <div class="col-sm-8">
                  <h6>Ce site web est un exercice réalisé par des élèves de première année de l’école des Mines dans le cadre du cours de Description des controverses.
                  Ces sites sont le résultat de travail d’étudiants et sont mis en ligne pour des raisons pédagogiques et didactiques.</h6>
                </div>
              </div>
            </div>
          </div>
