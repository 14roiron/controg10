...
<p>
P. Jasco fait réponse à une série d'articles publiés par J.K. Vanclay entre 2008 et 2012. Ces articles formulent des objections par rapport au classement de revues, ou "journal ranking", via certains indicateurs bibliométriques, notamment le <a data-toggle="modal" href="modale_indices.php?c=journalimpactfactor" data-target="#infos">Journal Impact Factor</a>. Mais qu'est-ce que les indicateurs bibliométriques, quel est leur origine et que mesurent-ils ?
</p>
</div>
<div class="paragraphe">
...
<p>
Cette approche est sujette à désaccords, notamment lorsque des enjeux de financement de la recherche sont concernés. Par exemple, J.K. Vanclay, en 2012, critique le Journal Impact Factor, qui est un indicateur calculé par Thomson Reuters dans sa base de données.
</p>
...
Cela provoque des réactions virulentes :
    ...
    <small class="pull-right">P.Jasco, Grim tales about the impact factor and the h-index in the Web of Science and the Journal Citation Reports databases: reflections on Vanclay’s criticism, Scientometrics (2012) 92:325–354</small><br>
    </blockquote> 
 <br />
    ...
    <small class="pull-right">Michel Zitt, The journal impact factor: angel, devil, or scapegoat? A comment on J.K. Vanclay’s article 2011, Scientometrics 2012, 22 feb</small><br>
	</blockquote> 
 <br />
	

<p>
P. Jasco dénonce également un manque de pertinence dû à cette absence de sélection dans les articles :
</p>
